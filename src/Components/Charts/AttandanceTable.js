...
//   // useEffect(() => {
//   //   // Calculate status for each unique date
//   //   const dateStatusData = {};
//   //   data.forEach((datas) => {
//   //     const date = new Date(datas.timestamp).toLocaleDateString("en-US");

//   //     if (!dateStatusData[date]) {
//   //       dateStatusData[date] = "Your status here"; // Replace with your logic
//   //     }
//   //   });

//   //   setDateStatus(dateStatusData);
//   // }, [data]);
...
//               // const date = new Date(datas.timestamp).toLocaleDateString(
//               //   "en-US"
//               // );
//               // const status = dateStatus[date] || "No status available"; // Replace with your logic
